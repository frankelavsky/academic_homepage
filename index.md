...
As of Fall of 2026, I am an Assistant Professor of Data Science at [Cal Poly](https://www.calpoly.edu/), in San Luis Obispo.  I am also the Principal of my own consulting firm, specalizing in engineering, architecture, and R&D in the domains of data science, accessibility, and visualization tooling. I am open to collaboration with students, fellow academics, and NGO/non-profit, governmental/policy, and industry partners, which you can find more details about in my [call for collaborations](https://www.frank.computer/collab/).
...
I earned my PhD in Human-Computer Interaction at the [Human-Computer Interaction Institute](https://hcii.cmu.edu/) in [Carnegie Mellon University](https://www.cmu.edu/)'s School of Computer Science. I was advised by [Dominik Moritz](https://www.domoritz.de/) and [Patrick Carrington](https://www.patrickcarrington.com/) and was a member of the [Data Interaction Group](https://dig.cmu.edu/) and [AXLE Lab](https://axle-lab.com/).
