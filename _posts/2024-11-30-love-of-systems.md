...
My parting side-note here is that I also may have realized that I have a dislike of LLMs for reasons that are related to why I love systems. LLMs represent all the benefits of a shallow relationship with a system, to me. Perhaps tooling will improve around LLMs but at its core, I love being able to set up some deterministic outcomes or build functions that can reliably return an output based on some particular inputs.
