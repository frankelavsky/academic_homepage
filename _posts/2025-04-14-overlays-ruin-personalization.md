...
We need a foundation before "make it yours" becomes a useful motto anywhere. "Make it yours" doesn't work when the thing we're talking about is miserable to begin with. This is exactly why I chose to work with [Highcharts](https://www.highcharts.com/accessibility/) for my *softerware* project instead of a visualization library that had no accessibility at all. (There is third-party research that shows Highcharts is the [best of the best, when it comes to accessibility](https://onlinelibrary.wiley.com/doi/full/10.1111/cgf.14833).) Highcharts has done the minimum (arguably even gone above and beyond) when it comes to care and convenience for users with disabilities. And so that means that an exploration *softerware* can really get to the heart of personalization.
