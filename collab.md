...
1. [**2 free slots per year**]:
   1. 4 months of my time at 1 day/week (~**125 hours**). This is enough time for either: a med-scale accessibility eval, co-design + prototype development, *or* a full user study.
   2. 1-2 students supporting my work (when available/appropriate).
   3. (*Optional*): a write-up of our work, submitted as a short paper, workshop paper, or subpart of a larger ongoing paper.
2. [**1 free slot per summer**]:
   1. 10 weeks of my time (~**400 hours**), which is enough time for 1 full R&D project, well-scoped.
   2. 1-2 students supporting my work (when available/appropriate).
...
And as strange as might seem, I could be a "hired hand" (so to speak) in *your* research! **Do you need help visualizing data effectively?** My [prior visualization work](https://www.frank.computer/projects/#Older-No-Accessibility-Guaranteed) has won awards, and even appeared in the [Nobel Lecture on Physics](https://journals.aps.org/rmp/abstract/10.1103/RevModPhys.90.040502)! **Do you need help working on accessibility**, with co-design, or running an HCI study for the first time? [I've played that role before](https://dl.acm.org/doi/10.1145/3663548.3675665), too! I'm also happy to just serve as a **more-senior paper editor/writer** too. I'm quite a seasoned peer reviewer (7 of my 36 reviews during my PhD won awards or recognitions for their high quality).

### Student collabs

> Note: Are you a current or incoming student at Cal Poly? Great! Then keep reading. If not, please note that I am generally not interested in advising or working with students from other institutions. I have limited time and space to bring students on to my own projects, and I need to prioritize mentorship and training for the students here at my own institution. However, if you are a PhD student or student researcher who is *already involved in an on-going project* of your own or someone else's, I'd be happy to at least chat about what you're up to and ways that I can support *your* work (rather than the other way around).
